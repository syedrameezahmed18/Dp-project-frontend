...
const Step4 = (props) => {
  return (
    ...
    <p class="step-heading-light" style={{ color: Colors.blackColor }}>{`Enter your CNIC number`}</p>
    <input value={props.currentVal} className="step-input" type="text" onChange={e => props.onChange("cnicNum", e.target.value)} />
