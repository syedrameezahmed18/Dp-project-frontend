...
const Step1 = (props) => {
    return (
            ...
            <div class="step-main-inputdiv">
                ...
                <p class="step-heading-light" style={{color:Colors.blackColor}}>Please enter your name</p>
                <input value={props.currentVal} className="step-input" type="text" onChange={e => props.onChange("name",e.target.value)}/>
